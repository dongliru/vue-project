  ...
  <div class="detail-wrap">
    <div class="detail-left">
      <div class="product-board">
        <img :src="productIcon">
        <ul>
          <router-link v-for="item in products" :to='"/detail/"+item.path' tag="li" active-class="active">
            {{ item.name }}
          </router-link>
        </ul>
      </div>
...
export default {
  data () {
    return {
      ...
      ImgSrc:{
        ...
        "/detail/analysic":require("../assets/images/2.png"),
  ...
  computed:{
    productIcon(){
      return this.ImgSrc[this.$route.path]
    }
  }
